...
<html lang="en">
  ...
  <head>
    ...
    <title>WarehouseConnect - Profile Page (Lessee)</title>
          ...
          <div class="product-item-title d-flex">
            <div class="bg-faded p-5 d-flex mr-auto rounded fwh-search-block">
              <h2 class="section-heading mb-0">
                <span class="section-heading-upper">WarehouseConnect - Lessee</span>
          ...
          <div class="about-heading-content">
            <div class="row">
              <div class="col-xl-9 col-lg-10 mx-auto">
                ...
                $result = mysqli_query($conn,"SELECT * FROM `Lessee` where email='".$id."'");
...
<center>
             ...
             <br><br>
              <center><p>Click here to access a catered list of analytics designed for lessees: </p></center>
              <center><a style = "color:black" href="https://vbruzos.shinyapps.io/LesseeTextAnalytics/"><u>Lessee Analytics</u></a></center><br>  
              <br>

              <!-- <u><h3>List of Open Applications</h3></u> -->
              <center><u><h3>Your Leases:</h3></u>

              <?php
                $result2= mysqli_query($conn,"SELECT * FROM `Lease` where lesseeEmail='".$id."'");
